...
int getActiveRuntimeVirtualManifest(wrap::android::content::Context const &context, Json::Value &virtualManifest,
    ...
    if (!hasQueryBroker) {
        ...
        __android_log_print(ANDROID_LOG_INFO, TAG,
                            "Got runtime: package: %s, so filename: %s, native lib dir: %s, has functions: %s", packageName.c_str(),
    ...
    if (!hasQueryBroker) {
        jni::Array<std::string> projection = makeArray(
            {api_layer::Columns::PACKAGE_NAME, api_layer::Columns::FILE_FORMAT_VERSION, api_layer::Columns::NAME,
             ...
             api_layer::Columns::IMPLEMENTATION_VERSION, api_layer::Columns::DESCRIPTION, api_layer::Columns::DISABLE_SYS_PROP,
             api_layer::Columns::ENABLE_SYS_PROP, api_layer::Columns::HAS_FUNCTIONS, api_layer::Columns::HAS_INSTANCE_EXTENSIONS});
