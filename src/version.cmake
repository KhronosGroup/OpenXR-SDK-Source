...
if(EXISTS "${OPENXR_SOURCE_DIR}/specification/registry/xr.xml")
    file(STRINGS ${OPENXR_SOURCE_DIR}/specification/registry/xr.xml lines REGEX "#define <name>XR_CURRENT_API_VERSION")
else()
    file(STRINGS ${OPENXR_SOURCE_DIR}/include/openxr/openxr.h lines REGEX "#define XR_CURRENT_API_VERSION")
endif()
