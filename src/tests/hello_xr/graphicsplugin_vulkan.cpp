...
struct VulkanGraphicsPluginLegacy : public VulkanGraphicsPlugin {
    ...
    virtual XrResult CreateVulkanInstanceKHR(XrInstance instance, const XrVulkanInstanceCreateInfoKHR* createInfo,
                                                      ...
                                                      &extensionNames[0]));
        {
            ...
            LogVulkanExtensions("Vulkan Interface Extensions, requested by runtime", extensions);
            ...
            LogVulkanExtensions("Vulkan Interface Extensions, requested by application", extensions,
