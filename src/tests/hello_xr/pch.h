...
#define ENABLE_EXT_EYE_TRACKING (PLATFORM_PC && 0)
...
#define ADAPT_VIVE_TRACKER_POSES (ENABLE_VIVE_TRACKERS && 0)
...
#define USE_WAIST_ORIENTATION_FOR_STICK_DIRECTION (ENABLE_BODY_TRACKING && USE_THUMBSTICKS_FOR_SMOOTH_LOCOMOTION && 0)
#define SUPPORT_BACKWARDS_WAIST_ORIENTATION (USE_WAIST_ORIENTATION_FOR_STICK_DIRECTION && ENABLE_VIVE_TRACKERS && 0)
#define BACKWARDS_DOT_PRODUCT_THRESHOLD -0.5f

#define DRAW_LOCAL_BODY_JOINTS (ENABLE_BODY_TRACKING && 0)
#define DRAW_WORLD_BODY_JOINTS (ENABLE_BODY_TRACKING && USE_THUMBSTICKS_FOR_SMOOTH_LOCOMOTION && 0)
...
#define PREFER_SNAP_TURNING (USE_THUMBSTICKS_FOR_SMOOTH_LOCOMOTION && 1)
...
#define DRAW_WORLD_POSES (USE_THUMBSTICKS_FOR_SMOOTH_LOCOMOTION && 0)
