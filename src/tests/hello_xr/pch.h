...
#define ENABLE_OPENXR_META_BODY_TRACKING_FIDELITY (ENABLE_OPENXR_FB_BODY_TRACKING && 1)
#define ENABLE_OPENXR_META_FULL_BODY_TRACKING 1

#define ENABLE_BODY_TRACKING ENABLE_OPENXR_FB_BODY_TRACKING
