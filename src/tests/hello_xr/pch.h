...
#define ENABLE_VIVE_SHOULDERS (ENABLE_VIVE_TRACKERS && 0) 
#define ENABLE_VIVE_ELBOWS (ENABLE_VIVE_TRACKERS && 0) 
#define ENABLE_VIVE_KNEES (ENABLE_VIVE_TRACKERS && 0) 
#define ENABLE_VIVE_WRISTS (ENABLE_VIVE_TRACKERS && 0) 
#define ENABLE_VIVE_ANKLES (ENABLE_VIVE_TRACKERS && 0) 
#define ENABLE_VIVE_WAIST (ENABLE_VIVE_TRACKERS && 0) 
#define ENABLE_VIVE_CHEST (ENABLE_VIVE_TRACKERS && 0) 
#define ENABLE_VIVE_CAMERA (ENABLE_VIVE_TRACKERS && 0) 
#define ENABLE_VIVE_KEYBOARD (ENABLE_VIVE_TRACKERS && 0) 
