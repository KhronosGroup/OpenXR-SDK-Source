...
#define ADAPT_WAIST_POSE_TO_BELT (ENABLE_VIVE_TRACKERS && 1)
...
#define SUPPORT_BACKWARDS_WAIST_ORIENTATION (USE_WAIST_ORIENTATION_FOR_STICK_DIRECTION && 0)
...
#define DRAW_WAIST_TRACKER_POSE (ENABLE_VIVE_TRACKERS && 1)
