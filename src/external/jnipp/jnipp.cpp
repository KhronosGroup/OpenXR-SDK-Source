...
ScopedEnv::~ScopedEnv() {
    if (_vm && _attached) _vm->DetachCurrentThread();
}

void ScopedEnv::init(JavaVM* vm) {
    if (_env != nullptr) return;

    if (vm == nullptr) throw InitializationException("JNI not initialized");
...
static std::string toString(jobject handle, bool deleteLocal = true) {
    ...
    if (handle != nullptr) {
        ...
        if (deleteLocal) env->DeleteLocalRef(handle);
    }
...
void init(JNIEnv* env) {
    ...
    if (isVm.compare_exchange_strong(expected, true)) {
        if (javaVm == nullptr && env->GetJavaVM(&javaVm) != 0) throw InitializationException("Could not acquire Java VM");
    }
}
...
Object::Object(const Object& other) : _handle(nullptr), _class(nullptr), _isGlobal(!other.isNull()) {
    if (!other.isNull()) _handle = env()->NewGlobalRef(other._handle);
}
...
Object::Object(jobject ref, int scopeFlags) : _handle(ref), _class(nullptr), _isGlobal((scopeFlags & Temporary) == 0) {
    ...
    if (scopeFlags & DeleteLocalInput) env->DeleteLocalRef(ref);
}

Object::~Object() noexcept {
    JNIEnv* env = jni::env();

    if (_isGlobal) env->DeleteGlobalRef(_handle);

    if (_class != nullptr) env->DeleteGlobalRef(_class);
}
...
Object& Object::operator=(const Object& other) {
    if (_handle != other._handle) {
        ...
        if ((_isGlobal = !other.isNull()) != false) _handle = env->NewGlobalRef(other._handle);
...
bool Object::operator==(const Object& other) const { return env()->IsSameObject(_handle, other._handle) != JNI_FALSE; }
...
bool Object::isNull() const noexcept { return _handle == nullptr || env()->IsSameObject(_handle, nullptr); }

template <>
void Object::callMethod(method_t method, internal::value_t* args) const {
    env()->CallVoidMethodA(_handle, method, (jvalue*)args);
    handleJavaExceptions();
}

template <>
bool Object::callMethod(method_t method, internal::value_t* args) const {
...
template <>
bool Object::get(field_t field) const {
...
template <>
byte_t Object::callMethod(method_t method, internal::value_t* args) const {
...
template <>
wchar_t Object::callMethod(method_t method, internal::value_t* args) const {
...
template <>
short Object::callMethod(method_t method, internal::value_t* args) const {
...
template <>
int Object::callMethod(method_t method, internal::value_t* args) const {
...
template <>
long long Object::callMethod(method_t method, internal::value_t* args) const {
...
template <>
float Object::callMethod(method_t method, internal::value_t* args) const {
...
template <>
double Object::callMethod(method_t method, internal::value_t* args) const {
...
template <>
std::string Object::callMethod(method_t method, internal::value_t* args) const {
...
template <>
std::wstring Object::callMethod(method_t method, internal::value_t* args) const {
    auto result = env()->CallObjectMethodA(_handle, method, (jvalue*)args);
    handleJavaExceptions();
...
template <>
jni::Object Object::callMethod(method_t method, internal::value_t* args) const {
    auto result = env()->CallObjectMethodA(_handle, method, (jvalue*)args);
    handleJavaExceptions();
...
template <>
byte_t Object::get(field_t field) const {
    return env()->GetByteField(_handle, field);
}

template <>
wchar_t Object::get(field_t field) const {
    return env()->GetCharField(_handle, field);
}

template <>
short Object::get(field_t field) const {
    return env()->GetShortField(_handle, field);
}

template <>
int Object::get(field_t field) const {
    return env()->GetIntField(_handle, field);
}

template <>
long long Object::get(field_t field) const {
    return env()->GetLongField(_handle, field);
}

template <>
float Object::get(field_t field) const {
    return env()->GetFloatField(_handle, field);
}

template <>
double Object::get(field_t field) const {
    return env()->GetDoubleField(_handle, field);
}

template <>
std::string Object::get(field_t field) const {
    return toString(env()->GetObjectField(_handle, field));
}

template <>
std::wstring Object::get(field_t field) const {
    return toWString(env()->GetObjectField(_handle, field));
}

template <>
Object Object::get(field_t field) const {
...
method_t Object::getMethod(const char* nameAndSignature) const { return Class(getClass(), Temporary).getMethod(nameAndSignature); }
...
field_t Class::getField(const char* name, const char* signature) const {
    ...
    if (id == nullptr) throw NameResolutionException(name);
...
method_t Class::getMethod(const char* nameAndSignature) const {
    ...
    if (sig != nullptr) return getMethod(std::string(nameAndSignature, sig - nameAndSignature).c_str(), sig);

    if (id == nullptr) throw NameResolutionException(nameAndSignature);
...
method_t Class::getStaticMethod(const char* nameAndSignature) const {
    ...
    if (sig != nullptr) return getStaticMethod(std::string(nameAndSignature, sig - nameAndSignature).c_str(), sig);
...
Class Class::getParent() const { return Class(env()->GetSuperclass(getHandle()), DeleteLocalInput); }

std::string Class::getName() const { return Object::call<std::string>("getName"); }
...
template <>
wchar_t Class::callStaticMethod(method_t method, internal::value_t* args) const {
...
template <>
long long Class::callStaticMethod(method_t method, internal::value_t* args) const {
...
template <>
std::string Class::callStaticMethod(method_t method, internal::value_t* args) const {
...
template <>
std::wstring Class::callStaticMethod(method_t method, internal::value_t* args) const {
    auto result = env()->CallStaticObjectMethodA(getHandle(), method, (jvalue*)args);
    handleJavaExceptions();
    return toWString(result);
}
...
template <>
jni::Object Class::callStaticMethod(method_t method, internal::value_t* args) const {
    auto result = env()->CallStaticObjectMethodA(getHandle(), method, (jvalue*)args);
    handleJavaExceptions();
    return Object(result, DeleteLocalInput);
}
...
template <>
void Class::callExactMethod(jobject obj, method_t method, internal::value_t* args) const {
    env()->CallNonvirtualVoidMethodA(obj, getHandle(), method, (jvalue*)args);
    handleJavaExceptions();
}

template <>
bool Class::callExactMethod(jobject obj, method_t method, internal::value_t* args) const {
...
template <>
byte_t Class::callExactMethod(jobject obj, method_t method, internal::value_t* args) const {
...
template <>
wchar_t Class::callExactMethod(jobject obj, method_t method, internal::value_t* args) const {
...
template <>
short Class::callExactMethod(jobject obj, method_t method, internal::value_t* args) const {
...
template <>
int Class::callExactMethod(jobject obj, method_t method, internal::value_t* args) const {
...
template <>
long long Class::callExactMethod(jobject obj, method_t method, internal::value_t* args) const {
...
template <>
float Class::callExactMethod(jobject obj, method_t method, internal::value_t* args) const {
...
template <>
double Class::callExactMethod(jobject obj, method_t method, internal::value_t* args) const {
...
template <>
std::string Class::callExactMethod(jobject obj, method_t method, internal::value_t* args) const {
...
template <>
std::wstring Class::callExactMethod(jobject obj, method_t method, internal::value_t* args) const {
    auto result = env()->CallNonvirtualObjectMethodA(obj, getHandle(), method, (jvalue*)args);
    handleJavaExceptions();
    return toWString(result);
}
...
template <>
Object Class::callExactMethod(jobject obj, method_t method, internal::value_t* args) const {
    auto result = env()->CallNonvirtualObjectMethodA(obj, getHandle(), method, (jvalue*)args);
    handleJavaExceptions();
    return Object(result, DeleteLocalInput);
}
...
Object Enum::get(const char* name) const { return Class::get<Object>(getStaticField(name, _name.c_str())); }
...
template <>
Array<bool>::Array(long length) : Object(env()->NewBooleanArray(length)), _length(length) {}

template <>
Array<byte_t>::Array(long length) : Object(env()->NewByteArray(length)), _length(length) {}

template <>
Array<wchar_t>::Array(long length) : Object(env()->NewCharArray(length)), _length(length) {}

template <>
Array<short>::Array(long length) : Object(env()->NewShortArray(length)), _length(length) {}

template <>
Array<int>::Array(long length) : Object(env()->NewIntArray(length)), _length(length) {}

template <>
Array<long long>::Array(long length) : Object(env()->NewLongArray(length)), _length(length) {}

template <>
Array<float>::Array(long length) : Object(env()->NewFloatArray(length)), _length(length) {}

template <>
Array<double>::Array(long length) : Object(env()->NewDoubleArray(length)), _length(length) {}

template <>
Array<std::string>::Array(long length)
    : Object(env()->NewObjectArray(length, Class("java/lang/String").getHandle(), nullptr)), _length(length) {}
...
Array<Object>::Array(long length)
    : Object(env()->NewObjectArray(length, Class("java/lang/Object").getHandle(), nullptr)), _length(length) {}

template <>
Array<Object>::Array(long length, const Class& type)
    : Object(env()->NewObjectArray(length, type.getHandle(), nullptr)), _length(length) {}
...
#ifndef _WIN32
static bool fileExists(const std::string& filePath) { return access(filePath.c_str(), F_OK) != -1; }
...
static std::pair<ssize_t, std::string> readlink_as_string(const char* pathname) {
    char buf[2048] = {};
...
static std::string detectJvmPath() {
    ...
    if (result.length() == 0) {
        ...
        if ((size = ::GetEnvironmentVariableA("JAVA_HOME", (LPSTR)buffer, sizeof(buffer))) != 0) {
            ...
            std::string options[] = {javaHome + "\\jre\\bin\\client\\jvm.dll", javaHome + "\\jre\\bin\\server\\jvm.dll",
                                     javaHome + "\\bin\\client\\jvm.dll", javaHome + "\\bin\\server\\jvm.dll"};
    ...
    if (javaHome != nullptr) {
        ...
        if (!path.empty()) {
            ...
            if (!javaHome.empty()) {
                std::string options[] = {
                    javaHome + "/jre/lib/amd64/server/libjvm.so", javaHome + "/jre/lib/amd64/client/libjvm.so",
                    javaHome + "/jre/lib/server/libjvm.so",       javaHome + "/jre/lib/client/libjvm.so",
                    javaHome + "/lib/server/libjvm.so",           javaHome + "/lib/client/libjvm.so",
                };
...
Vm::Vm(const char* path_) {
    ...
    if (path.length() == 0) throw InitializationException("Could not locate Java Virtual Machine");
    if (!isVm.compare_exchange_strong(expected, true)) throw InitializationException("Java Virtual Machine already initialized");
...
std::string valueSig(const Object* obj) {
    if (obj == nullptr || obj->isNull()) return "Ljava/lang/Object;";  // One can always hope...
...
void valueArg(value_t* v, const std::string& a) { ((jvalue*)v)->l = env()->NewStringUTF(a.c_str()); }
...
void valueArg(value_t* v, const char* a) { ((jvalue*)v)->l = env()->NewStringUTF(a); }

void valueArg(value_t* v, std::nullptr_t) { ((jvalue*)v)->l = nullptr; }
...
void valueArg(value_t* v, const std::wstring& a) { ((jvalue*)v)->l = env()->NewString((const jchar*)a.c_str(), jsize(a.length())); }

void valueArg(value_t* v, const wchar_t* a) { ((jvalue*)v)->l = env()->NewString((const jchar*)a, jsize(std::wcslen(a))); }
#else
...
long getArrayLength(jarray array) { return env()->GetArrayLength(array); }
}
}
