...
| Discovery
    ...
    <<android-api-layer-discovery, APK packaged and system installed manifest JSON>>
    files for API layers and the <<android-active-runtime-location, ContentProvider>>
    for the runtime.
| Extension
