...
Currently, the provided API Layers use this structure and the loader
uses a structure which has a subset of the function pointers (defined
in `xr_generated_dispatch_table_core.h`).
