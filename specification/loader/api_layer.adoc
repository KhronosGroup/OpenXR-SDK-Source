...
. `/product/etc/openxr/1/api_layers/implicit.d`
. `/odm/etc/openxr/1/api_layers/implicit.d`
. `/oem/etc/openxr/1/api_layers/implicit.d`
. `/system/etc/openxr/1/api_layers/implicit.d`
. `/vendor/etc/openxr/1/api_layers/implicit.d`

===== Explicit API Layers

. `/product/etc/openxr/1/api_layers/explicit.d`
. `/oem/etc/openxr/1/api_layers/explicit.d`
. `/vendor/etc/openxr/1/api_layers/explicit.d`
. `/system/etc/openxr/1/api_layers/explicit.d`
. `/odm/etc/openxr/1/api_layers/explicit.d`
...
----
  ...
  * pname:layerRequest must be a valid pointer to a
    sname:XrNegotiateApiLayerRequest structure.
...
fname:xrNegotiateLoaderApiLayerInterface function, the loader will create a
...
sname:XrNegotiateApiLayerRequest to allow the API layer to properly respond
to the request.
...
fname:xrNegotiateLoaderApiLayerInterface function and each API layer then
must: :
...
XrResult xrCreateApiLayerInstance(
    ...
    XrInstance *instance);
----
  * pname:info is a pointer to the sname:XrInstanceCreateInfo information
    passed into the standard fname:xrCreateInstance command.
  * pname:layerInfo is a pointer to an sname:XrApiLayerCreateInfo structure
...
----
  ...
  * pname:nextInfo is a pointer to the sname:XrApiLayerNextInfo structure
