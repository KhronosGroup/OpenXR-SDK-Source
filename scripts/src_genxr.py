...
from sample_impl_source_generator import SampleImplementationSourceGeneratorOptions, SampleImplementationSourceOutputGenerator
...
def makeGenOpts(args):
    ...
    genOpts['xr_generated_sample_impl.cpp'] = [
          SampleImplementationSourceOutputGenerator,
          SampleImplementationSourceGeneratorOptions(
            filename          = 'xr_generated_sample_impl.cpp',
            directory         = directory,
            apiname           = 'openxr',
            profile           = None,
            versions          = featuresPat,
